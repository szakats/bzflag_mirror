...
std::vector<std::string> tokenize(const std::string& in, const std::string &delims, const int maxTokens = 0, const bool useQuotes = false, size_t offset = 0);
...
inline size_t firstVisible(const std::string &v)
{
